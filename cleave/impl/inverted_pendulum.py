...
#                                       x=10, y=screen_h - 58)
#         label_force = pyglet.text.Label(text='', font_size=18,
#         color=draw_color,
#                                         x=10, y=screen_h - 88)
#         label_time = pyglet.text.Label(text='', font_size=18,
#         color=draw_color,
#                                        x=10, y=screen_h - 118)
#
...
#         self._labels['x'].text = f'Cart X: {self._cart_body.position[
#         0]:0.3f} m'
#         # TODO: fix magic number
#         self._labels['angle'].text = f'Pendulum Angle: ' \
#                                      f'{self._pend_body.angle *
#                                      57.2958:0.3f}' \
#                                      f' degrees'
#
